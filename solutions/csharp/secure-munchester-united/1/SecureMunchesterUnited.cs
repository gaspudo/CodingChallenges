public class SecurityPassMaker
{
    ...
    {
        if (support.GetType() == typeof(Manager) || support.GetType() == typeof(Chairman)) return "Too Important for a Security Pass";
        else if (support.GetType() == typeof(Security)) return $"{support.Title} Priority Personnel";
